...
\textit{EngLife Community Instructor} \hfill Feb 2023 - June 2023\\
\vspace{-1mm}
\begin{itemize} \itemsep 1pt
    \item Led both online and in-person workshops at Nelson Mandela Public High School.
	\item Designed and lead six STEM workshops focused on high schools students.
    \item The topics covered include Programming, Structural Integrity and Electronics.
\end{itemize}
...
\textbf{Engineering Outreach, University of Toronto} \hfill Toronto, CA\\
\textit{DEEP Summer Program Instructor} \hfill Feb 2020 - May 2020\\
\vspace{-1mm}
\begin{itemize} \itemsep 1pt
	\item Designed programming courses for the DEEP program, an educational program offered by UofT.
\end{itemize}

\header{Skills}
\begin{tabular}{ l l }
	Programming Languages: & Python, C++, C, Kotlin, JavaScript, Go                                   \\
...
\begin{itemize} \itemsep 0.5pt
	\item Elected to represent 700+ students at the highest level of governance in the Eng. Society.
	\item As a Board Member, I collaborated with other representatives to make executive decisions about the operation of the Society that offers services to 6000+ students at the University of Toronto.
\end{itemize}
...
\begin{itemize} \itemsep 0.5pt
    ...
    \item Organized many open-source workshops including the first GitHub Field Day in Canada.
\end{itemize}
...
\vspace{-1mm}
\begin{itemize} \itemsep 0.5pt
	\item Managed a team of 180+ active members spread across nine departments using JIRA.
	\item Organized joint events with different organizations like the Hatchery, UCL AI Society, AI@MIT, Harvard Open Data Project and many more.
\end{itemize}
...
A detailed and informal description of who I am. Built using raw HTML, CSS and PHP.\\
\vspace*{1mm}
